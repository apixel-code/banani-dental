// Floating WhatsApp button with subtle pulse + entry animation
...
export default function WhatsAppButton() {
  return (
    ...
    >
      ...
      <span className="absolute inset-0 rounded-full bg-[#25D366]/20 animate-ping" style={{ animationDelay: "0.6s" }} aria-hidden />

      <span className="relative flex items-center justify-center w-14 h-14 md:w-16 md:h-16 rounded-full bg-[#25D366] text-white shadow-[0_8px_30px_rgba(37,211,102,0.5)] hover:shadow-[0_14px_40px_rgba(37,211,102,0.65)] transition-shadow">
        <svg
